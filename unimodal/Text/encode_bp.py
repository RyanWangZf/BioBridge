...
def main(
    ...
    tokenized_data_dir = os.path.join(data_path, "./encoded_bp")
    ...
    if not os.path.exists(tokenized_data_dir):
        def tokenize_data(datapoint):
            ...
            return tokenized
        data = load_dataset("csv", data_files=os.path.join(data_path, "biological.csv"))
    ...
    with open(os.path.join(output_path, "bp.pkl"), "wb") as f:
        pickle.dump(
            outputs,
            f,
        )
